...
if("TRUE" STREQUAL "TRUE")
  set(nmea_navsat_driver_SOURCE_PREFIX /home/jetson/Self-Driving-Delivery-Robot/src/utils/gps_src/nmea_navsat_driver)
  set(nmea_navsat_driver_DEVEL_PREFIX /home/jetson/Self-Driving-Delivery-Robot/devel/.private/nmea_navsat_driver)
  ...
  set(nmea_navsat_driver_INSTALL_PREFIX /home/jetson/Self-Driving-Delivery-Robot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nmea_navsat_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jetson/Self-Driving-Delivery-Robot/src/utils/gps_src/nmea_navsat_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jetson/Self-Driving-Delivery-Robot/devel/.private/nmea_navsat_driver/lib;/home/jetson/Self-Driving-Delivery-Robot/devel/lib;/opt/ros/melodic/lib)
...
set(depends "roscpp;rosmsg;rospy;nav_msgs;geometry_msgs;sensor_msgs")
