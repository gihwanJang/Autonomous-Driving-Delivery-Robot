...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/jetson/Self-Driving-Delivery-Robot/src/utils/gpu_stereo_image_proc/libSGM'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jetson/Self-Driving-Delivery-Robot/src/utils/gpu_stereo_image_proc/libSGM'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
